...
# n_neighbors parameter from the UMAP
bm1_merged <- runUmap(bm1_merged, n_neighbors = 20)
...
# information to the colData to use the later functions in CopyKit
...
consensusPhylo(bm1_merged) <-
  ape::rotate(consensusPhylo(bm1_merged), 7)
